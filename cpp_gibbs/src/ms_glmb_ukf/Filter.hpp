...
public:
    ...
    Filter() {
        H_upd = 3000;  // requested number of updated components/hypotheses
        H_max = 3000; // cap on number of posterior components/hypotheses
        hyp_threshold = 1e-5;  // pruning threshold for components/hypotheses
        ...
        gamma = 62.19979206;  // chi2.ppf(self.P_G, model.z_dim), inv chi^2 dn gamma value
        gate_flag = 1;  // gating on or off 1/0
